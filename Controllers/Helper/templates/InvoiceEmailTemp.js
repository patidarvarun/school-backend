...
const InvoiceEmailFormat = (Getinvoice, invoice_items) => {
  return `
  ${HeaderTemplate()}
  <tr>
  ...
  <td align="center">
        <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            ...
            <strong>Amount Due : </strong> ${formatePrice(
              Getinvoice[0]?.amount
            )} (QAR)
          </span>
                                </td>
            ...
            <strong>Due Date : </strong> ${moment(
              ...
              "DD/MM/YYYY"
                      ...
                      <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                        <td>
                            <h3 class="align-right">Invoice Created Date : ${moment(
                      ...
                      <p style="line-height: 13pt;font-size: inherit;">
    You can make this payment instantly using the secure link below 
</p>
